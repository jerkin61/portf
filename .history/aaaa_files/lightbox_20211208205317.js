...
($(".links-check" ).on('click', function() { 
  ...
  ($(".trial-and-error" ).on('click', function() { 
	console.log ("clicked");
	if ($(".preview-image-holder").attr("data-vbid") == "vbid-0676d39c-vr71v3pf-holder")
	{$(".links-check").hide()};
	if ($(".preview-image-holder").attr("data-vbid") == "vbid-0676d39c-6pun72q7-holder")
	{$(".links-check").hide()};
	if ($(".preview-image-holder").attr("data-vbid") == "vbid-0676d39c-y2ojlb72-holder")
	{$(".links-check").hide()};
	if ($(".preview-image-holder").attr("data-vbid") == "vbid-0676d39c-ukuxod6x-holder")
	{$(".links-check").hide()};
