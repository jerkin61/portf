...
($(".image-link" ).on('load', function() {
	var data = ["vbid-e090b014-k7qlgmcz", "vbid-e090b014-d9ta4ouk", "vbid-e090b014-inbnpdpn","vbid-e090b014-k7qlgmcz"];
	if ($(".light-box-image").attr("data-vbid") == data )
	{$(".links-check").show()} 
	else {
	$(".links-check").hide()
	}
